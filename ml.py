...
def testClassifiers(dataset):
	...
	# classifiers['svm'] = getMeanAuc(svm_thing, dataset)
...
def makeArray(data):
	...
	emotionalRatio = sum(1 for word in title.lower().split(' ') if word in emotional_words)/sum(1 for word in title.split(' '))
